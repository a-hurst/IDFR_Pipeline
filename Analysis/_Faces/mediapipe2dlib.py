...
LM68_EXT_LOWER_EYE_R = [143, 117, 118, 119, 120, 121, 128]
LM68_EXT_LOWER_EYE_L = [357, 350, 349, 348, 347, 346, 372]
LM68_EXT_NOSE_REGION = [142, 203, 423, 371]
...
LM68_EXT = (
    ...
    LM68_EXT_NOSE_REGION + LM68_EXT_MOUTH_REGION
)
